...
#MySQL specific
#For lookups by name
#Case-insensitive lookups are not supported by MySQL
#It also doesn't support regular text indices
create index summoner_summoner_name_index on summoner (region, summoner_name(64));
